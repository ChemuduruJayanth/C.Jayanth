...
datagroup: c_jayanth_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: c_jayanth_default_datagroup
...
# To see the Explore you’re building, navigate to the Explore menu and select an Explore under "C Jayanth"
...
explore: order_items {
  sql_always_where: ${returned_date} >= '2018-12-31' ;;
  join: orders {
    type: left_outer
